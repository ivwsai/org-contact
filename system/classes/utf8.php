...
class Netap_UTF8
{
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return mb_strlen($str, Netap::$charset);
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return mb_strpos($str, $search, $offset, Netap::$charset);
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return mb_strrpos($str, $search, $offset, Netap::$charset);
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return ($length === NULL) ? mb_substr($str, $offset, mb_strlen($str), Netap::$charset) : mb_substr($str, $offset, $length, Netap::$charset);
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return mb_strtolower($str, Netap::$charset);
    ...
    {
        if (Netap_UTF8::$server_utf8)
            return mb_strtoupper($str, Netap::$charset);
...
if (Netap_UTF8::$server_utf8 === NULL) {
    // Determine if this server supports UTF-8 natively
    Netap_UTF8::$server_utf8 = extension_loaded('mbstring');
}
